...
const SDL_Rect RECT_MOTEUR_GRIS = {768,1088,128,128};
const SDL_Rect RECT_HUILE_GRIS = {896,1088,128,128};
const SDL_Rect RECT_ESSENCE_GRIS = {512,1088,128,128};
const SDL_Rect RECT_ROUE_GRIS = {640,1088,128,128};

const SDL_Rect RECT_ESSENCE = {0,1088,128,128};
const SDL_Rect RECT_MOTEUR= {256,1088,128,128};
const SDL_Rect RECT_HUILE = {384,1088,128,128};
const SDL_Rect RECT_ROUE = {128,1088,128,128};
