                 ...
                 std::make_pair(0,0), std::make_pair(WIDTH_FENETRE_PRINCIPALE, 60))
{
    ...
    m_zoneNomPersonnage = new TexteSDL("Nom", SDL_Color{255,255,255,255}, POLICE_COLLEGED, 20, std::make_pair(m_fondDescription.x + 10, m_fondDescription.y + 10));
    m_zoneNiveauPersonnage = new TexteSDL("Niveau", SDL_Color{255,255,255,255}, POLICE_COLLEGED, 20, std::make_pair(m_fondDescription.x + 90, m_fondDescription.y + 10));
    m_zoneViePersonnage = new TexteSDL("Vie", SDL_Color{255,255,255,255}, POLICE_COLLEGED, 20, std::make_pair(m_fondDescription.x + 210, m_fondDescription.y + 10));           // position imprécise **
    m_zoneIntelligencePersonnage = new TexteSDL("Intelligence", SDL_Color{255,255,255,255}, POLICE_COLLEGED, 20, std::make_pair(m_fondDescription.x + 290, m_fondDescription.y + 10));
    m_zoneForcePersonnage = new TexteSDL("Force", SDL_Color{255,255,255,255}, POLICE_COLLEGED, 20, std::make_pair(m_fondDescription.x + 510, m_fondDescription.y + 10));
    m_zoneVitessePersonnage = new TexteSDL("Vitesse", SDL_Color{255,255,255,255}, POLICE_COLLEGED, 20, std::make_pair(m_fondDescription.x + 640, m_fondDescription.y + 10));
